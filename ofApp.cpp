...
void ofApp::setup(){
    ofSetFrameRate(60);
    img2.load("Untitled-1.jpg");
    ps = new particlesystem(ofPoint(ofGetWidth()/2, ofGetHeight()-75) );
}
...
//    ps = new particlesystem(ofPoint(mouse.x, mouse.y), img);
